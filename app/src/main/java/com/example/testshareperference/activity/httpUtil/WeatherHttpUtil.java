...
public class WeatherHttpUtil {
    ...
    //要访问的网址(留下的接口)
    String url =" https://www.mxnzp.com/api/weather/current/";
    String endURL="?app_id=h0gppttquqmsfkoh&app_secret=bXJDMzZqbldRbTF6c3Z1OWxmRHpxZz09";



    //参数reBack就是要传输的反馈字符串
    public String sendURLRequestForSentence(String address) throws InterruptedException {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Request request = new Request.Builder().url(url +address+endURL).build();
